# PriorZero：连接语言先验与世界模型的决策框架 交互式教程

基于论文 *PriorZero: Bridging Language Priors and World Models for Decision Making*，由 **paper-skill** 生成的完整 React + TypeScript + Vite 网页项目。
