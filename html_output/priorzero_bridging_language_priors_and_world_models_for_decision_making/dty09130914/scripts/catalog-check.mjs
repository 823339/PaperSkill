...
const expected = ['1.1', '1.2', '2.1', '3.1', '4.1', '5.1', '6.1', '7.1', '7.2', '8.1', '8.2', '8.3', '9.1', '10.1', '10.2', '11.1'];
...
if (!tutorial.includes('BV1DdL36tEXW')) errors.push('existing Bilibili recommendation was dropped');
